...
Output from `gbuild` will look something like
    ...
    From https://github.com/herbsters/herbsters
...
[herbsters/gitian.sigs.herbs](https://github.com/herbsters/gitian.sigs.herbs/) repository, or if that's not possible create a pull
