...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the herbstersTestFramework
    pass

class ExampleTest(herbstersTestFramework):
    # Each functional test is a subclass of the herbstersTestFramework class.
    ...
    def custom_method(self):
        ...
        herbstersTestFramework class so other tests can use it."""
