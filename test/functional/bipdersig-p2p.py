...
class BIP66Test(herbstersTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # herbstersd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and herbstersd produces more specific reject
            # reasons.
