...
# TestNode: A peer we use to send messages to herbstersd, and store responses.
...
class CompactBlocksTest(herbstersTestFramework):
    ...
    # This test actually causes herbstersd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that herbstersd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for herbstersd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # herbstersd will not send blocktxn responses for blocks whose height is
