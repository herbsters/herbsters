...
unlocked to sign the herbsters-Qt.app bundle.
...
allowing somebody to distribute a herbsters-Qt.app or herbsters-qt-setup.exe with a valid
...
that the herbsters-qt.exe file inside the installer had not been tampered with.
