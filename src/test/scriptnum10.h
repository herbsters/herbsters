...
#ifndef herbsters_TEST_SCRIPTNUM10_H
#define herbsters_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from herbsters Core 0.10.0, for cross-comparison.
 */
public:
