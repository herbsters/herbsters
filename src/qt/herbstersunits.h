...
#ifndef herbsters_QT_herbstersUNITS_H
#define herbsters_QT_herbstersUNITS_H
...
/** herbsters unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class herbstersUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit herbstersUnits(QObject *parent);

    /** herbsters units.
      @note Source: https://en.herbsters.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef herbstersUnits::Unit herbstersUnit;

#endif // herbsters_QT_herbstersUNITS_H
