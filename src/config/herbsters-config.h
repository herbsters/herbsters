/* src/config/herbsters-config.h.  Generated from herbsters-config.h.in by configure.  */
/* src/config/herbsters-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef herbsters_CONFIG_H

#define herbsters_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The herbsters Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "herbsters Core"
...
#define PACKAGE_BUGREPORT "https://github.com/herbsters/herbsters/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "herbsters Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "herbsters Core 0.15.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "herbsters"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://herbsters.org/"
