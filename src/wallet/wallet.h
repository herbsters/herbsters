...
#ifndef herbsters_WALLET_WALLET_H
#define herbsters_WALLET_WALLET_H
...
public:
     ...
     * on this herbsters node, and set to 0 for transactions that were created
...
#endif // herbsters_WALLET_WALLET_H
